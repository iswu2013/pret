...
import com.pret.vo.req.PPertServiceLineItemDeleteVo;
...
public class HPertServiceLineItemDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertServiceLineItemDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertServiceLineItemDeleteVo res = (PPertServiceLineItemDeleteVo) requestBody;
