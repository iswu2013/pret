...
import com.pret.vo.req.PPertPriceItemDeleteVo;
...
public class HPertPriceItemDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertPriceItemDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertPriceItemDeleteVo res = (PPertPriceItemDeleteVo) requestBody;
