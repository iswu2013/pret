...
import com.pret.vo.req.PPertAreaDeleteVo;
...
public class HPertAreaDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertAreaDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertAreaDeleteVo res = (PPertAreaDeleteVo) requestBody;
