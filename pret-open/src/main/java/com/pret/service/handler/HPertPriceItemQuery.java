...
import com.pret.vo.req.PPertPriceItemQueryVo;
...
public class HPertPriceItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertPriceItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertPriceItemQueryVo res = (PPertPriceItemQueryVo) requestBody;
