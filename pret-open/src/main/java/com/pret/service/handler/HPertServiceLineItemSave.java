...
import com.pret.vo.req.PPertServiceLineItemSaveVo;
...
public class HPertServiceLineItemSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertServiceLineItemSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertServiceLineItemSaveVo res = (PPertServiceLineItemSaveVo) requestBody;
