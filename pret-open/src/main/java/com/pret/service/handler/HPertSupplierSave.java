...
import com.pret.vo.req.PPertSupplierSaveVo;
...
public class HPertSupplierSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertSupplierSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertSupplierSaveVo res = (PPertSupplierSaveVo) requestBody;
