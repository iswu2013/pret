...
import com.pret.vo.req.PPertOverExpenditureAuditDeleteVo;
...
public class HPertOverExpenditureAuditDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOverExpenditureAuditDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertOverExpenditureAuditDeleteVo res = (PPertOverExpenditureAuditDeleteVo) requestBody;
