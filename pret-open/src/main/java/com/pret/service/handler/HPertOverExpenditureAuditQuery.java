...
import com.pret.vo.req.PPertOverExpenditureAuditQueryVo;
...
public class HPertOverExpenditureAuditQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOverExpenditureAuditQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertOverExpenditureAuditQueryVo res = (PPertOverExpenditureAuditQueryVo) requestBody;
