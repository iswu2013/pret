...
import com.pret.vo.req.PPertSupplierUpdateVo;
...
public class HPertSupplierUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertSupplierUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertSupplierUpdateVo res = (PPertSupplierUpdateVo) requestBody;
