...
import com.pret.vo.req.PPertOverExpenditureAuditUpdateVo;
...
public class HPertOverExpenditureAuditUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOverExpenditureAuditUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertOverExpenditureAuditUpdateVo res = (PPertOverExpenditureAuditUpdateVo) requestBody;
