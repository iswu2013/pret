...
import com.pret.vo.req.PPertSupplierDetailVo;
...
public class HPertSupplierDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertSupplierDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertSupplierDetailVo res = (PPertSupplierDetailVo) requestBody;
