...
import com.pret.vo.req.PPertPriceItemSaveVo;
...
public class HPertPriceItemSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertPriceItemSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertPriceItemSaveVo res = (PPertPriceItemSaveVo) requestBody;
