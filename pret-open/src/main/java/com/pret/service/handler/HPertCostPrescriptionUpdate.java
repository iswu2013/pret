...
import com.pret.vo.req.PPertCostPrescriptionUpdateVo;
...
public class HPertCostPrescriptionUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCostPrescriptionUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertCostPrescriptionUpdateVo res = (PPertCostPrescriptionUpdateVo) requestBody;
