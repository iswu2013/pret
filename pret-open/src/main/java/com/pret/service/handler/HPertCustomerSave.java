...
import com.pret.vo.req.PPertCustomerSaveVo;
...
public class HPertCustomerSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCustomerSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertCustomerSaveVo res = (PPertCustomerSaveVo) requestBody;
