...
import com.pret.vo.req.PPertAreaDetailVo;
...
public class HPertAreaDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertAreaDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertAreaDetailVo res = (PPertAreaDetailVo) requestBody;
