...
import com.pret.vo.req.PPertCustomerDeleteVo;
...
public class HPertCustomerDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCustomerDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertCustomerDeleteVo res = (PPertCustomerDeleteVo) requestBody;
