...
import com.pret.vo.req.PPertPriceItemDetailVo;
...
public class HPertPriceItemDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertPriceItemDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertPriceItemDetailVo res = (PPertPriceItemDetailVo) requestBody;
