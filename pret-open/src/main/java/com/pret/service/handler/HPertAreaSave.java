...
import com.pret.vo.req.PPertAreaSaveVo;
...
public class HPertAreaSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertAreaSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertAreaSaveVo res = (PPertAreaSaveVo) requestBody;
