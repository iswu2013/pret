...
import com.pret.vo.req.PPertOrderAdditionalCostsUpdateVo;
...
public class HPertOrderAdditionalCostsUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOrderAdditionalCostsUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertOrderAdditionalCostsUpdateVo res = (PPertOrderAdditionalCostsUpdateVo) requestBody;
