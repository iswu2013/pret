...
import com.pret.vo.req.PPertAreaQueryVo;
...
public class HPertAreaQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertAreaQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertAreaQueryVo res = (PPertAreaQueryVo) requestBody;
