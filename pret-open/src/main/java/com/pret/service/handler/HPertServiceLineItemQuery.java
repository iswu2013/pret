...
import com.pret.vo.req.PPertServiceLineItemQueryVo;
...
public class HPertServiceLineItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertServiceLineItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertServiceLineItemQueryVo res = (PPertServiceLineItemQueryVo) requestBody;
