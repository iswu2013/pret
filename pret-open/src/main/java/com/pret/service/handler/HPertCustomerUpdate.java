...
import com.pret.vo.req.PPertCustomerUpdateVo;
...
public class HPertCustomerUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCustomerUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertCustomerUpdateVo res = (PPertCustomerUpdateVo) requestBody;
