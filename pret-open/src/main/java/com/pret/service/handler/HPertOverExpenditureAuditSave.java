...
import com.pret.vo.req.PPertOverExpenditureAuditSaveVo;
...
public class HPertOverExpenditureAuditSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOverExpenditureAuditSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertOverExpenditureAuditSaveVo res = (PPertOverExpenditureAuditSaveVo) requestBody;
