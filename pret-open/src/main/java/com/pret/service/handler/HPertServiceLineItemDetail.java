...
import com.pret.vo.req.PPertServiceLineItemDetailVo;
...
public class HPertServiceLineItemDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertServiceLineItemDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertServiceLineItemDetailVo res = (PPertServiceLineItemDetailVo) requestBody;
