...
import com.pret.vo.req.PPertCostPrescriptionQueryVo;
...
public class HPertCostPrescriptionQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCostPrescriptionQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertCostPrescriptionQueryVo res = (PPertCostPrescriptionQueryVo) requestBody;
