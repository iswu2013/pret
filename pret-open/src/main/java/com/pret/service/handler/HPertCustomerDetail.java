...
import com.pret.vo.req.PPertCustomerDetailVo;
...
public class HPertCustomerDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCustomerDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertCustomerDetailVo res = (PPertCustomerDetailVo) requestBody;
