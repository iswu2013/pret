...
import com.pret.vo.req.PPertSupplierQueryVo;
...
public class HPertSupplierQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertSupplierQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertSupplierQueryVo res = (PPertSupplierQueryVo) requestBody;
