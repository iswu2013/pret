...
import com.pret.vo.req.PPertCostPrescriptionDeleteVo;
...
public class HPertCostPrescriptionDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCostPrescriptionDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertCostPrescriptionDeleteVo res = (PPertCostPrescriptionDeleteVo) requestBody;
