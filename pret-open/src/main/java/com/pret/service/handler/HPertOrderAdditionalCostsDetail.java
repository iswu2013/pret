...
import com.pret.vo.req.PPertOrderAdditionalCostsDetailVo;
...
public class HPertOrderAdditionalCostsDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOrderAdditionalCostsDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPertOrderAdditionalCostsDetailVo res = (PPertOrderAdditionalCostsDetailVo) requestBody;
