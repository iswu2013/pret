...
import com.pret.vo.req.PPertCostPrescriptionSaveVo;
...
public class HPertCostPrescriptionSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertCostPrescriptionSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertCostPrescriptionSaveVo res = (PPertCostPrescriptionSaveVo) requestBody;
