...
import com.pret.vo.req.PPertOrderAdditionalCostsSaveVo;
...
public class HPertOrderAdditionalCostsSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPertOrderAdditionalCostsSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPertOrderAdditionalCostsSaveVo res = (PPertOrderAdditionalCostsSaveVo) requestBody;
