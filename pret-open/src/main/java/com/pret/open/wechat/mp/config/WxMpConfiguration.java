package com.pret.open.wechat.mp.config;

import java.util.Map;

import com.pret.open.wechat.mp.handler.*;
import com.pret.open.wechat.mp.handler.*;
    ...
    public Object services() {
       ...
       /* mpServices = this.properties.getConfigs()
            ...
            .map(a -> {
                ...
                WxMpService goods = new WxMpServiceImpl();
                goods.setWxMpConfigStorage(configStorage);
                routers.put(a.getAppId(), this.newRouter(goods));
                return goods;
