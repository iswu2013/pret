...
import com.pret.open.vo.req.PPretBillingIntervalItemSaveVo;
...
public class HPretBillingIntervalItemSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretBillingIntervalItemSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretBillingIntervalItemSaveVo res = (PPretBillingIntervalItemSaveVo) requestBody;
        return pretBillingIntervalItemService.save(res);
    }
}
