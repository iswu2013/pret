...
import com.pret.open.vo.req.PPretPickUpPlanItemQueryVo;
...
public class HPretPickUpPlanItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretPickUpPlanItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretPickUpPlanItemQueryVo res = (PPretPickUpPlanItemQueryVo) requestBody;
        return pretPickUpPlanItemService.query(res);
    }
}
