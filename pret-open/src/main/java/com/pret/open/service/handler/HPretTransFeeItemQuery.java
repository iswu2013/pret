...
import com.pret.open.vo.req.PPretTransFeeItemQueryVo;
...
public class HPretTransFeeItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransFeeItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransFeeItemQueryVo res = (PPretTransFeeItemQueryVo) requestBody;
        return pretTransFeeItemService.query(res);
    }
}
