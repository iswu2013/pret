...
import com.pret.open.vo.req.PPretQuotationItemQueryVo;
...
public class HPretQuotationItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretQuotationItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretQuotationItemQueryVo res = (PPretQuotationItemQueryVo) requestBody;
        return pretQuotationItemService.query(res);
    }
}
