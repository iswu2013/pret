...
import com.pret.open.vo.req.PPretAdressDetailVo;
...
public class HPretAdressDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretAdressDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPretAdressDetailVo res = (PPretAdressDetailVo) requestBody;
        return pretAdressService.detail(res);
    }
}
