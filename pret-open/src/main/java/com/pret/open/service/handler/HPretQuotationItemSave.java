...
import com.pret.open.vo.req.PPretQuotationItemSaveVo;
...
public class HPretQuotationItemSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretQuotationItemSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretQuotationItemSaveVo res = (PPretQuotationItemSaveVo) requestBody;
        return pretQuotationItemService.save(res);
    }
}
