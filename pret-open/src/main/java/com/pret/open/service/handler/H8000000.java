...
import com.pret.open.vo.req.P8000000Vo;
...
public class H8000000 extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(H8000000.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        LOGGER.info(TAG, "获取司机备货列表");
        P8000000Vo res = (P8000000Vo) requestBody;
        return service.getPickupPlanList(res);
    }
}
