...
import com.pret.open.vo.req.PPretCustomerAddressQueryVo;
...
public class HPretCustomerAddressQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretCustomerAddressQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretCustomerAddressQueryVo res = (PPretCustomerAddressQueryVo) requestBody;
        return pretCustomerAddressService.query(res);
    }
}
