...
import com.pret.open.vo.req.P1000002Vo;
...
public class H1000002 extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(H1000002.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        LOGGER.info(TAG, "进厂确认");
        P1000002Vo res = (P1000002Vo) requestBody;
        return service.inFactory(res);
    }
}
