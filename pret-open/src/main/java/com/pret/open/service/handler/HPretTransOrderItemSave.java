...
import com.pret.open.vo.req.PPretTransOrderItemSaveVo;
...
public class HPretTransOrderItemSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransOrderItemSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransOrderItemSaveVo res = (PPretTransOrderItemSaveVo) requestBody;
        return pretTransOrderItemService.save(res);
    }
}
