...
import com.pret.open.vo.req.PPretPickUpPlanItemUpdateVo;
...
public class HPretPickUpPlanItemUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretPickUpPlanItemUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretPickUpPlanItemUpdateVo res = (PPretPickUpPlanItemUpdateVo) requestBody;
        return pretPickUpPlanItemService.update(res);
    }
}
