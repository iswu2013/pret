...
import com.pret.open.vo.req.PPretAdressSaveVo;
...
public class HPretAdressSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretAdressSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretAdressSaveVo res = (PPretAdressSaveVo) requestBody;
        return pretAdressService.save(res);
    }
}
