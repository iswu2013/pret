...
import com.pret.open.vo.req.PPretServiceRouteOrginQueryVo;
...
public class HPretServiceRouteOrginQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretServiceRouteOrginQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretServiceRouteOrginQueryVo res = (PPretServiceRouteOrginQueryVo) requestBody;
        return pretServiceRouteOrginService.query(res);
    }
}
