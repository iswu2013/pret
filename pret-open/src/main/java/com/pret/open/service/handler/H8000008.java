...
import com.pret.open.vo.req.P8000008Vo;
...
public class H8000008 extends BaseContext implements JopHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(H8000008.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        LOGGER.info(TAG, "根据提货计划获取司机详情");
        P8000008Vo res = (P8000008Vo) requestBody;
        return service.getDriveryByPickUpPlanEwm(res);
    }
}
