...
import com.pret.open.vo.req.PPretTransTrajectorySaveVo;
...
public class HPretTransTrajectorySave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransTrajectorySave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransTrajectorySaveVo res = (PPretTransTrajectorySaveVo) requestBody;
        return pretTransTrajectoryService.save(res);
    }
}
