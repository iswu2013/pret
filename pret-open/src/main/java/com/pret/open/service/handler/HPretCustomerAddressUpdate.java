...
import com.pret.open.vo.req.PPretCustomerAddressUpdateVo;
...
public class HPretCustomerAddressUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretCustomerAddressUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretCustomerAddressUpdateVo res = (PPretCustomerAddressUpdateVo) requestBody;
        return pretCustomerAddressService.update(res);
    }
}
