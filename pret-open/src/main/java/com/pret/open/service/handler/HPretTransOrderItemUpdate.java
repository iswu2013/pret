...
import com.pret.open.vo.req.PPretTransOrderItemUpdateVo;
...
public class HPretTransOrderItemUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransOrderItemUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransOrderItemUpdateVo res = (PPretTransOrderItemUpdateVo) requestBody;
        return pretTransOrderItemService.update(res);
    }
}
