...
import com.pret.open.vo.req.PPretAdressQueryVo;
...
public class HPretAdressQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretAdressQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretAdressQueryVo res = (PPretAdressQueryVo) requestBody;
        return pretAdressService.query(res);
    }
}
