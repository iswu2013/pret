...
import com.pret.open.vo.req.PPretGoodsQueryVo;
...
public class HPretGoodsQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretGoodsQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretGoodsQueryVo res = (PPretGoodsQueryVo) requestBody;
        return pretGoodsService.query(res);
    }
}
