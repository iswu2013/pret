...
import com.pret.open.vo.req.PPretTransOrderItemQueryVo;
...
public class HPretTransOrderItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransOrderItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransOrderItemQueryVo res = (PPretTransOrderItemQueryVo) requestBody;
        return pretTransOrderItemService.query(res);
    }
}
