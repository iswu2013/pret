...
import com.pret.open.vo.req.PPretCustomerAddressSaveVo;
...
public class HPretCustomerAddressSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretCustomerAddressSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretCustomerAddressSaveVo res = (PPretCustomerAddressSaveVo) requestBody;
        return pretCustomerAddressService.save(res);
    }
}
