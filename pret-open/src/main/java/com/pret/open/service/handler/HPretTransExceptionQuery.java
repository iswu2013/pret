...
import com.pret.open.vo.req.PPretTransExceptionQueryVo;
...
public class HPretTransExceptionQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransExceptionQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransExceptionQueryVo res = (PPretTransExceptionQueryVo) requestBody;
        return pretTransExceptionService.query(res);
    }
}
