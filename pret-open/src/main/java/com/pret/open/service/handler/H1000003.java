...
public class H1000003 extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(H1000003.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        P1000003Vo res = (P1000003Vo) requestBody;
        return service.outFactory(res);
    }
}
