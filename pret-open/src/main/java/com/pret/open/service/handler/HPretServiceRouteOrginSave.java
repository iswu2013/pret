...
import com.pret.open.vo.req.PPretServiceRouteOrginSaveVo;
...
public class HPretServiceRouteOrginSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretServiceRouteOrginSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretServiceRouteOrginSaveVo res = (PPretServiceRouteOrginSaveVo) requestBody;
        return pretServiceRouteOrginService.save(res);
    }
}
