...
import com.pret.open.vo.req.PPretTransTrajectoryUpdateVo;
...
public class HPretTransTrajectoryUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransTrajectoryUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransTrajectoryUpdateVo res = (PPretTransTrajectoryUpdateVo) requestBody;
        return pretTransTrajectoryService.update(res);
    }
}
