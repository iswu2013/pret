...
import com.pret.open.vo.req.PPretTransTrajectoryQueryVo;
...
public class HPretTransTrajectoryQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransTrajectoryQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransTrajectoryQueryVo res = (PPretTransTrajectoryQueryVo) requestBody;
        return pretTransTrajectoryService.query(res);
    }
}
