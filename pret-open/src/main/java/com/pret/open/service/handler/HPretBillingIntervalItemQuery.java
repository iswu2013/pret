...
import com.pret.open.vo.req.PPretBillingIntervalItemQueryVo;
...
public class HPretBillingIntervalItemQuery extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretBillingIntervalItemQuery.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretBillingIntervalItemQueryVo res = (PPretBillingIntervalItemQueryVo) requestBody;
        return pretBillingIntervalItemService.query(res);
    }
}
