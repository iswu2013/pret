...
public class H8000001 extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(H8000001.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        P8000001Vo res = (P8000001Vo) requestBody;
        return service.getPickupPlanDetail(res);
    }
}
