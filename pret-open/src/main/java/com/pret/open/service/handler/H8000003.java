...
public class H8000003 extends BaseContext implements JopHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(H8000003.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        P8000003Vo res = (P8000003Vo) requestBody;
        return service.getTransPlanDetail(res);
    }
}
