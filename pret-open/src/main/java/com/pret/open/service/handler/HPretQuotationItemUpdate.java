...
import com.pret.open.vo.req.PPretQuotationItemUpdateVo;
...
public class HPretQuotationItemUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretQuotationItemUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretQuotationItemUpdateVo res = (PPretQuotationItemUpdateVo) requestBody;
        return pretQuotationItemService.update(res);
    }
}
