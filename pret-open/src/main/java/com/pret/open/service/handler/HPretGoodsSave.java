...
import com.pret.open.vo.req.PPretGoodsSaveVo;
...
public class HPretGoodsSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretGoodsSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretGoodsSaveVo res = (PPretGoodsSaveVo) requestBody;
        return pretGoodsService.save(res);
    }
}
