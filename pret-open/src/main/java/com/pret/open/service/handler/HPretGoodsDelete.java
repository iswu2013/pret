...
import com.pret.open.vo.req.PPretGoodsDeleteVo;
...
public class HPretGoodsDelete extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretGoodsDelete.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPretGoodsDeleteVo res = (PPretGoodsDeleteVo) requestBody;
        return pretGoodsService.delete(res);
    }
}
