...
import com.pret.open.vo.req.PPretTransExceptionUpdateVo;
...
public class HPretTransExceptionUpdate extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransExceptionUpdate.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransExceptionUpdateVo res = (PPretTransExceptionUpdateVo) requestBody;
        return pretTransExceptionService.update(res);
    }
}
