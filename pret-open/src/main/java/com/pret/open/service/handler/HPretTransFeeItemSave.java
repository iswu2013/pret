...
import com.pret.open.vo.req.PPretTransFeeItemSaveVo;
...
public class HPretTransFeeItemSave extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretTransFeeItemSave.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        ...
        PPretTransFeeItemSaveVo res = (PPretTransFeeItemSaveVo) requestBody;
        return pretTransFeeItemService.save(res);
    }
}
