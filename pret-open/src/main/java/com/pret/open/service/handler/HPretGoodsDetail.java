...
import com.pret.open.vo.req.PPretGoodsDetailVo;
...
public class HPretGoodsDetail extends BaseContext implements JopHandler{
    private static final Logger LOGGER = LoggerFactory.getLogger(HPretGoodsDetail.class);
    ...
    public ResBody handle(ReqBody requestBody) {
        PPretGoodsDetailVo res = (PPretGoodsDetailVo) requestBody;
        return pretGoodsService.detail(res);
    }
}
