...
import com.pret.user.common.annotation.Limit;
import com.pret.user.common.domain.LimitType;
import com.pret.user.common.exception.LimitAccessException;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.pret.user.common.annotation.Limit)")
