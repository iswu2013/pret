...
public class EntityUtils {
    ...
    public static <T> void setCreateInfo(T entity) {
        ...
        String name = "";
        String id = "";
        GetUserInfo getUserInfo = new GetUserInfo(request, hostIp, name, id).invoke();
        // 默认属性
    ...
    private static class GetUserInfo {
        ...
        public GetUserInfo(HttpServletRequest request, String hostIp, String name, String id) {
