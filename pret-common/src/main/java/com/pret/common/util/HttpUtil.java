...
public class HttpUtil {
     ...
     * @return
     */
    public static String post(List<HeaderProperty> headerPropertyList, String url, String params) {
        try {
            CloseableHttpClient httpClient = HttpClients.createDefault();
            HttpPost httpPost = new HttpPost(url);
            for (HeaderProperty headerProperty : headerPropertyList) {
                httpPost.addHeader(headerProperty.getName(), headerProperty.getValue());
            }
