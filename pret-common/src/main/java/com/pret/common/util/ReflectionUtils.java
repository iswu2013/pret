...
import com.pret.common.vo.NameValue;
...
public class ReflectionUtils {
     ...
     * @Param: [obj, list]
            ...
            * @Date: 2019/7/13  8:25
     */
    public static void setArrFieldValue(final Object obj, List<NameValue> list) {
        for(NameValue nameValue:list) {
           setFieldValue(obj,nameValue.getName(),nameValue.getValue());
        }
    }
