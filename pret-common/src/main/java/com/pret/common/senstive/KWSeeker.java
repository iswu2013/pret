...
public class KWSeeker {
     ...
     * 所有的关键词
     */
    private List<KeyWord> sensitiveWords;
     ...
     */
    public KWSeeker(List<KeyWord> sensitiveWords) {
    ...
    private static class DataInit {
         ...
         */
        public int generalTree(List<KeyWord> sensitiveWords, Map<String, Map> wordsTree) {
